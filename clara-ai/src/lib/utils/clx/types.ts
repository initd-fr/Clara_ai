...
export interface ClassedFunctionType {
  <
    ...
    Variants extends
      ClassedComponentVariants<Composers> = ClassedComponentVariants<Composers>,
    Props extends
      ClassedComponentProps<Composers> = ClassedComponentProps<Composers>,
  >(
    type: Type,
    ...composers: Composers
  ): ClassedComponentType<Type, Props, Variants>;
}
