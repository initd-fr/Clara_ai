    ...
    <div className="absolute right-4 top-4 z-10">
      ...
      >
        <input
          ...
          checked={isDark}
          aria-label="Contrôleur de thème"
        />
        <svg
          className="swap-off h-6 w-6 fill-current transition-colors duration-200 group-hover:text-primary-content"
        ...
        <svg
          className="swap-on h-6 w-6 fill-current text-base-content transition-colors duration-200 group-hover:text-primary-content"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          aria-hidden="true"
        >
